      ...
      <div className="relative hidden md:flex flex-col justify-between p-10 text-white dark:border-r overflow-hidden">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-4 max-w-lg">
            <p className="text-2xl font-medium leading-relaxed italic text-white/95">
              &ldquo;Finally, an AI that understands academic structure. I save hours of manual organizing every single day.&rdquo;
            </p>
            <footer className="text-sm">
              <div className="font-semibold text-primary">Marcus Thorne</div>
              <div className="text-white/60">PhD Candidate, CS</div>
            </footer>
          </blockquote>
        </div>
